        ...
        throw std::runtime_error(
            RPCHelpMan{"addnode",
                ...
                "Or try a connection to a node once.\n",
                {
                    ...
                    {"privileged", RPCArg::Type::BOOL, /* opt */ true, /* default_val */ "true", "If true, nodes added will be protected from DoS disconnection and not required to be full nodes or support segwit as other outbound peers are (though such peers will not be synced from). Only supported for command \"onetry\" for now."},
                },
                RPCResults{},
                RPCExamples{
