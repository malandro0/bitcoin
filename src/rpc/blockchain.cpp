...
static RPCHelpMan scantxoutset()
{
    ...
    return RPCHelpMan{"scantxoutset",
        ...
        {
            RPCResult{"When action=='abort'", RPCResult::Type::BOOL, "success", "True if scan will be aborted (not necessarily before this RPC call returns), or false if there is no scan to abort."},
            RPCResult{"When action=='status' and no scan is in progress - possibly already completed", RPCResult::Type::NONE, "", ""},
            RPCResult{"When action=='status' and scan is currently in progress", RPCResult::Type::OBJ, "", "",
            {
