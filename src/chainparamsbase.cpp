...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-vbparams=deployment:@startheight:@timeoutheight:@min_activation_height:lockinontimeout", "Use given start/timeout/min-activation heights and lockinontimeout (0/1) for specified version bits deployment (regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
