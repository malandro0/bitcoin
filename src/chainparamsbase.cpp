...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-vbparams=deployment:start:end[:min_activation_height]", "Use given start/end times/heights and min_activation_height for specified version bits deployment (prefix start/end with '@' to specify heights; regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
