...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-vbparams=deployment:start:end[:min_activation_height]:lockinontimeout", "Use given start/end times/heights, min_activation_height, and lockinontimeout (0/1) for specified version bits deployment (prefix start/end with '@' to specify heights; regtest-only)", ArgsManager::ALLOW_ANY | ArgsManager::DEBUG_ONLY, OptionsCategory::CHAINPARAMS);
