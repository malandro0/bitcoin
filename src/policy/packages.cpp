...
bool CheckPackage(const Package& txns, PackageValidationState& state)
{
    ...
    // NOTE: total_size here doesn't account for non-weight vsize, which require input data; so, it's checked again later in MemPoolAccept::AcceptMultipleTransactions
