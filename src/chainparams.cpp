...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].startheight = 681408; // Approximately May 1st, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].timeoutheight = 760032; // Approximately October 29th, 2022
...
public:
    CTestNetParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].bit = 2;
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].startheight = 681408; // Approximately May 1st, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].timeoutheight = 697536; // Approximately August 21st, 2021
...
void CRegTestParams::UpdateActivationParametersFromArgs(const ArgsManager& args)
{
    ...
    for (const std::string& strDeployment : args.GetArgs("-vbparams")) {
        ...
        if (vDeploymentParams[1].empty() || vDeploymentParams[1].substr(0, 1) != "@" || !ParseInt32(vDeploymentParams[1].substr(1), &startheight)) {
        ...
        for (int j=0; j < (int)Consensus::MAX_VERSION_BITS_DEPLOYMENTS; ++j) {
            if (vDeploymentParams[0] == VersionBitsDeploymentInfo[j].name) {
                ...
                found = true;
                LogPrintf("Setting version bits activation parameters for %s to startheight=%ld, timeoutheight=%ld, min_activation_height=%d, lockinontimeout=%d\n", vDeploymentParams[0], startheight, timeoutheight, min_activation_height, lockinontimeout);
                break;
            }
        }
        if (!found) {
