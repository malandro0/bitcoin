...
class Bip8Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(3)
        self.nodes[3].assert_start_raises_init_error(extra_args=["-vbparams=testdummy:@144:@-2:0"], expected_msg="Error: Invalid timeout (-2), cannot be negative (except for never or always active special cases)")
        ...
        self.nodes[3].assert_start_raises_init_error(extra_args=["-vbparams=testdummy:@-3:@144"], expected_msg="Error: Invalid start (-3), cannot be negative (except for never or always active special cases)")
        self.nodes[3].assert_start_raises_init_error(extra_args=["-vbparams=testdummy:@144:@-1:0"], expected_msg="Error: Invalid timeout (-1), cannot be negative (except for never or always active special cases)")
        self.nodes[3].assert_start_raises_init_error(extra_args=["-vbparams=testdummy:@{}:@144:0".format(MAX_HEIGHT + 1)], expected_msg="Error: Invalid start (@{})".format(MAX_HEIGHT + 1))
        self.nodes[3].assert_start_raises_init_error(extra_args=["-vbparams=testdummy:@144:@{}:0".format(MAX_HEIGHT + 1)], expected_msg="Error: Invalid end (@{})".format(MAX_HEIGHT + 1))
        self.nodes[3].assert_start_raises_init_error(extra_args=["-vbparams=testdummy:@{}:@144:0".format(-(MAX_HEIGHT + 2))], expected_msg="Error: Invalid start (@{})".format(-(MAX_HEIGHT + 2)))
        self.nodes[3].assert_start_raises_init_error(extra_args=["-vbparams=testdummy:@144:@{}:0".format(-(MAX_HEIGHT + 2))], expected_msg="Error: Invalid end (@{})".format(-(MAX_HEIGHT + 2)))
