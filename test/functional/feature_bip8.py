...
class Bip8Test(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.stop_node(3)
        self.nodes[3].assert_start_raises_init_error(extra_args=["-vbparams=testdummy:@1:@-2:0"], expected_msg="Error: Invalid timeoutheight (-2), cannot be negative (except for never or always active special cases)")
